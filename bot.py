...
TOKEN = "8352548859:AAGxEI9yk_4TZwHO9UFZ5A7AhNU3YlvD2hQ"   # توكن البوت
OWNER_ID = 6538981552   # ← معرفك التليجرام (أضفته هنا)

MAX_FILE_SIZE = 50 * 1024 * 1024  # 50 ميجا – حد تليجرام
...
async def compress_video(input_path: str, temp_dir: str) -> str | None:
    ...
    try:
        ...
        stream = ffmpeg.output(
            ...
            output_path,
            vcodec="libx264",
            crf=28,           # توازن جيد بين الجودة والحجم
            preset="veryfast",# أسرع
            acodec="aac",
...
def main():
    ...
    app.add_handler(CommandHandler("stats", owner_stats))          # أمر خاص بالمالك فقط
